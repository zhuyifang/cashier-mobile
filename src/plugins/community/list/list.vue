<template>
    <app-layout>
        ...
        <view v-if="list.length > 0">
            <view v-for="item in list" :key="item.id" v-if="item.goods_count > 0" class="list">
                ...
                <view @click="toDetail(item)" class="goods-list">
                    ...
                    <image class="right-arrow" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png"></image>
                </view>
        ...
        <view v-else class="empty-box">
            <image v-if="!loading" src="https://cashier.qicuo.com/app/static/image/no-goods.png"></image>
