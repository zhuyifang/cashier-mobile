    ...
    <app-layout>
        <view class="search">
            <view class="search-input dir-left-nowrap cross-center main-center">
                ...
                <image class="delete" @click="deleteKeyword" v-if="keyword.length > 0" src="https://cashier.qicuo.com/app/static/image/icon/delete-yuan.png"></image>
            </view>
            ...
            <view v-if="!isSearch && historyList.length > 0" class="history">
                <view class="dir-left-nowrap cross-center title">
                    ...
                    <image src="https://cashier.qicuo.com/app/static/image/icon/delete.png" class="box-grow-0" @click="deleteHistory"></image>
                </view>
