        ...
        <view class="pond">
            ...
            <view class="list">
                <view class="empty" v-if="pond.length === 0">
                    <view class="cart">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/nav-icon-cart.png"></image>
                    </view>
                    <text>凑单池还是空的哦</text>
                </view>
...
<style scoped lang="scss">
    ...
    .radio-single-active {
        ...
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/icon-checkbox-checked.png");
    }
    ...
    .app-can-add {
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/add-but.png");
    }
    .app-can-be-reduced {
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/subtract.png");
    }
    .all-select {
        width: 150upx;
        height: 100%;
