    ...
    <app-layout>
        <view class="header cross-center dir-top-nowrap" :style="{'background-image': `url(${region.stock})`}">
            ...
            <view @click="toDetail" class="to-cash">
                ...
                <image class="arrow-right" src='https://cashier.qicuo.com/app/static/image/icon/arrow-right-white.png'></image>
            </view>
        </view>
        <view class="cell">
        ...
        <view @click="show=!show" class="cell">
            <view class="main-between cell-item">
                ...
                <view>
                    <image :class="['arrow-right',`${show ? 'show' : ''}`,]" src='https://cashier.qicuo.com/app/static/image/icon/arrow-right.png'></image>
                </view>
            </view>
