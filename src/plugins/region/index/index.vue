            ...
            <view class="choose-level" v-if="applyArea">
                <view>
                    ...
                    <view @click="choose(1)" class="main-between cross-center choose-level-item">
                        ...
                        <image v-if="!up" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"></image>
                    </view>
                </view>
                <view>
                    <view>选择省</view>
                ...
                <view v-if="choose_level.id > 1">
                    ...
                    <view @click="choose(3)" class="main-between cross-center choose-level-item">
                        ...
                        <image class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"></image>
                    </view>
                </view>
