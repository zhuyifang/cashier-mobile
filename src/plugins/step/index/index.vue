    ...
    <app-layout>
        <view @click="toDetail">
            <view class='nav'>
                ...
                <image load-lazy='true' class='to-log' src='https://cashier.qicuo.com/app/static/image/icon/arrow-right.png'></image>
            </view>
        </view>
    ...
    .share-qr-code-poster {
        ...
        .app-icons {
            ...
            > view {
                ...
                .app-share {
                    background-image: url('https://cashier.qicuo.com/app/static/image/icon/share.png');
                }
                .app-code {
                    background-image: url('https://cashier.qicuo.com/app/static/image/icon/code.png');
                }
                .text {
                    font-size: #{26rpx};
                    color: #353535;
        ...
        .app-center {
            ...
            .app-close {
                ...
                background-size: cover;
                background-repeat: no-repeat;
                background-image: url("https://cashier.qicuo.com/app/static/image/icon/close.png");
                position: absolute;
                top: #{28rpx};
                right: #{24rpx};
