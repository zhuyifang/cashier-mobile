...
<style scoped lang="scss">
	...
	.icon {
		...
		position: absolute;
		right: 120upx;
		background-image: url("https://cashier.qicuo.com/app/static/image/icon/delete-yuan.png");
	...
	.delete-icon {
		width: 28upx;
		height: 32upx;
		background-image: url("https://cashier.qicuo.com/app/static/image/icon/delete.png");
		background-repeat: no-repeat;
		background-size: 100% 100%;
		z-index: 1000;
	}
