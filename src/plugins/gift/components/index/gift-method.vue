	...
	<view class="page-width gift-method">
        ...
        <view class="page-width method dir-left-nowrap cross-center">
			...
			>
	            ...
	            <image src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png" class="swipe-icon" v-if="type.length > 1"></image>
            </view>
            ...
            <view class="swipe-content dir-left-nowrap main-between cross-center">
	            ...
	            <template v-if="method_type === 'time_open'">
		            ...
		            <image class="right-icon" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png"></image>
	            </template >
