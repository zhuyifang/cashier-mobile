            ...
            <view class="app-item" v-for="(item,index) in list" :key="item.id">
                <view class="dir-left-nowrap cross-center app-item-title">
                    <view class="check-icon" @click="choose(index,item)">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/icon-uncheck.png" v-if="!item.choose"></image>
                        <image :style="{'background-color': theme.background,'opacity': `${item.type == 1 ? '0.3' : '1'}`}"  src="https://cashier.qicuo.com/app/static/image/icon/icon-checkbox-checked.png" v-else></image>
                    </view>
                ...
                <view class="item-goods dir-left-nowrap" v-for="goods in item.host_list" :key="goods.id">
                    <view class="check-icon">
                        <image :style="{'background-color': theme.background,'opacity': `${goods.opacity}`}" src="https://cashier.qicuo.com/app/static/image/icon/icon-checkbox-checked.png"></image>
                    </view>
                    ...
                    <view class="dir-top-nowrap goods-info">
                        ...
                        <view class="item-good-attr" v-if="!goods.choose_attr" @click="chooseAttr(goods,index)">
                            ...
                            <image class="item-good-attr-arrow" src="https://cashier.qicuo.com/app/static/image/icon/bottom.png"></image>
                        </view>
                ...
                <view class="item-goods dir-left-nowrap" v-for="(goods,idx) in item.goods_list" :key="goods.id">
                    <view class="check-icon" v-if="item.type == 2" @click="chooseGoods(idx,index,goods)">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/icon-uncheck.png" v-if="!goods.choose_goods"></image>
                        <image :style="{'background-color': theme.background}" src="https://cashier.qicuo.com/app/static/image/icon/icon-checkbox-checked.png" v-else></image>
                    </view>
                    <image @click="toDetail(goods.goods_id)" class="goods-img" :src="goods.cover_pic"></image>
                    <view v-if="goods.stock == 0 || item.stock == 0" class="out-dialog">
                        <image :src="appSetting.is_use_stock == '1' ? appImg.plugins_out : appSetting.sell_out_pic"></image>
