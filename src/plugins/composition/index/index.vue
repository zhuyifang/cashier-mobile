    ...
    <app-layout :overflow="false">
        ...
        <view class="search" @click="toSearch">
            <view class="search-view dir-left-nowrap main-center cross-center">
                <image class="image" src="https://cashier.qicuo.com/app/static/image/icon/icon-search.png"></image>
                <view class="text">请输入商品名称搜索</view>
            </view>
        </view>
        <view class='no-tip' v-if="list.length == 0">
            <image src="https://cashier.qicuo.com/app/static/image/no-goods.png"></image>
            <view>没有任何套餐哦~</view>
        </view>
