    ...
    <app-layout>
        <view class="search dir-left-nowrap cross-centers">
            <view class="search-view">
                ...
                <image v-if="getFocus && keyword.length > 0" @click="clearSearch" class="search-clear" src="https://cashier.qicuo.com/app/static/image/icon/delete-yuan.png"></image>
            </view>
        ...
        <view class="main-center no-result" v-if="list.length == 0 && searchResult">
            <view class="dir-left-nowrap cross-center">
                <image class="box-grow-0 empty" src="https://cashier.qicuo.com/app/static/image/icon/empty.png"></image>
            ...
            <view @click.stop="" class="dialog" :style="{'bottom':height +'px'}" :animation="animationData">
                <view class="dialog-title main-between cross-center">
                    <view @click="toDetail(detail)" class="toBuy dir-left-nowrap cross-center">
                        <image  :style="{'background-color': getTheme.background}" src="https://cashier.qicuo.com/app/static/image/icon/goods-cart.png"></image>
                        <view :style="{'color': getTheme.color}">去购买套餐</view>
                    </view>
                    <view class="close">
                        <image @click="close" src="https://cashier.qicuo.com/app/static/image/icon/close.png"></image>
                    </view>
                </view>
