                ...
                <view class="main-between user-name">
                    ...
                    <view class="cross-center rate">
                        ...
                        <view class="rate-icon" @click="toAbout">
                            <image src="https://cashier.qicuo.com/app/static/image/icon/question.png"></image>
                        </view>
                    </view>
                </view>
                <view class="dir-left-nowrap user-bonus">
                    <view @click="toStatics" class="user-bonus-item">
                        ...
                        <view>{{setting.form && setting.form.total_bonus?setting.form.total_bonus:'累计分红金额'}}
                            <image class="right-arrow" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right-white.png"></image>
                        </view>
                    </view>
            ...
            <view @click="toDetail">
                <view class="main-between bonus-item cash-bonus">
                    ...
                    <view class="bonus-price">
                        ...
                        <image src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png"></image>
                    </view>
                </view>
            </view>
                ...
                <view class="apply">
                    ...
                    <view class="apply-input" v-if="setting.is_agreement == 1">
                        <view class="read" @click="read=!read">
                            <image src="https://cashier.qicuo.com/app/static/image/icon/icon-uncheck.png" v-if="read == false"></image>
                            <image class="check-red" src="https://cashier.qicuo.com/app/static/image/icon/icon-checkbox-checked.png" v-else></image>
                        </view>
                        我已经阅读并了解
