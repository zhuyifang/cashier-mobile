...
.pond {
    ...
    .end {
        ...
        .end-icon.home {
            height: #{30rpx};
            width: #{30rpx};
            background-image: url('https://cashier.qicuo.com/app/static/image/icon/icon-home-white.png');
        }

        .end-icon.price {
            height: #{22rpx};
            width: #{12rpx};
            background-image: url('https://cashier.qicuo.com/app/static/image/icon/arrow-right-white.png');
        }
    }
