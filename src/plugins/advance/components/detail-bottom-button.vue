	...
	<view>
		<view class="bd-bottom dir-left-nowrap cross-center" v-if="active">
            ...
            <view @click="set_favorite(favorite)" class="bd-back dir-top-nowrap main-center cross-center box-grow-0" >
                <image class="bd-icon" :src="favorite ? 'https://cashier.qicuo.com/app/static/image/icon/icon-favorite-active.png' : 'https://cashier.qicuo.com/app/static/image/icon/icon-favorite.png'"></image>
