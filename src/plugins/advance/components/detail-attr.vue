        ...
        <view class="safe-area-inset-bottom u-bottom-fixed">
            <view class="attr-content" @tap.stop="preventD">
                <view class="top dir-left-nowrap">
                    ...
                    <image class="close" src="https://cashier.qicuo.com/app/static/image/icon/icon-close.png" @click="close_attr"></image>
                </view>
                ...
                <view class="bottom dir-left-nowrap main-between cross-center">
                    ...
                    <view class="num dir-right-nowrap main-between cross-center">
                        <image class="image" src="https://cashier.qicuo.com/app/static/image/cart/can-be-added.png" @click.stop="add_num"></image>
                        <input type="number" class="input" :value="num" @change="change_num">
                        <image class="image" :src="num === 1 ? '../image/can-be-reduced.png' : 'https://cashier.qicuo.com/app/static/image/cart/can-be-reduced.png'" @click.stop="edd_num"></image>
                    </view>
                </view>
