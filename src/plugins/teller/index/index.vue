                ...
                <view class="balance main-between cross-center" @click="toBalance">
                    <view class="dir-left-nowrap cross-center">
                        <view class="icon main-center cross-center">
                            <image src="https://cashier.qicuo.com/app/static/image/icon/cash/icon-balance.png"></image>
                        </view>
                        <view>账户余额</view>
                    </view>
                    <image class="right" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png"></image>
                </view>
            </view>
        </app-layout>
    </view>
