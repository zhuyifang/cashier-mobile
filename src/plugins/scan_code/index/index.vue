...
<style scoped lang="scss">
    ...
    .scan-offer {
        ...
        .icon-right {
            ...
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/arrow-right.png");
            width: #{12rpx};
            height: #{22rpx};
        }
    }
    ...
    .scan-integral-icon {
        height: #{36rpx};
        width: #{36rpx};
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/warning.png");
        background-repeat: no-repeat;
        background-size: 100% auto;
        margin-left: #{20rpx};
    }
    ...
    .scan-integral-switch.uncheck {
        margin-left: #{5rpx};
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/icon-uncheck.png");
    }
