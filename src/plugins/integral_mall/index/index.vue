	...
	<app-layout :overflow="false">
	    <view class="nav">
	        ...
	        <view @click="router('/plugins/integral_mall/exchange/exchange')" class="exchange">
	            <image load-lazy="true" src="https://cashier.qicuo.com/app/static/image/icon/exchange.png"></image>
	            <text>我的兑换</text>
	        </view>
	    ...
	    <view class="dialog-bg" v-if="lose || success">
	        <view class="dialog">
	            <view @click="close">
	                <image load-lazy="true" class="close" src="https://cashier.qicuo.com/app/static/image/icon/icon-close.png"></image>
	            </view>
