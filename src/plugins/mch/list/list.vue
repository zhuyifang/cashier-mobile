...
<style scoped lang="scss">
    .search-content {
        ...
        .icon-search {
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/icon-search.png");
            height: #{24rpx};
            width: #{24rpx};
    ...
    .mch-list-input {
        ...
        .close-word {
            ...
            .icon-close {
                background-image: url("https://cashier.qicuo.com/app/static/image/icon/icon-close.png");
                background-repeat: no-repeat;
                background-size: 100% auto;
                height: #{25rpx};
                width: #{25rpx};
