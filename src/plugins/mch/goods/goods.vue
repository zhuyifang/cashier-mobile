            ...
            <view class="recommend">
                <view class="recommend-title dir-left-nowrap main-center">
                    <view class="dir-left-nowrap cross-center">
                        ...
                        <image src="https://cashier.qicuo.com/app/static/image/icon/icon-favorite.png"></image>
            ...
            <view v-if="is_open == 1" class="safe-area-inset-bottom u-bottom-fixed">
                ...
                <view class="bd-bottom dir-left-nowrap" >
                    <view class="bd-back dir-top-nowrap main-center cross-center box-grow-0" @click="navShop">
                        <image class="bd-icon" src="https://cashier.qicuo.com/app/static/image/icon/icon-mch.png"></image>
                        <text>店铺</text>
                    </view>
                    <view class="bd-back dir-top-nowrap main-center cross-center box-grow-0" @click="back">
                        <image class="bd-icon" src="https://cashier.qicuo.com/app/static/image/icon/index.png"></image>
                        <text>首页</text>
                    </view>
                    <view class="bd-back dir-top-nowrap main-center cross-center box-grow-0" @click="favorite">
                        <image class="bd-icon" :src="goods.favorite ? 'https://cashier.qicuo.com/app/static/image/icon/icon-favorite-active.png' : 'https://cashier.qicuo.com/app/static/image/icon/icon-favorite.png'"></image>
                        <text>收藏</text>
                    </view>
