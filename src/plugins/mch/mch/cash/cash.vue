    ...
    <app-layout>
        <view class="cash-head dir-top-nowrap main-center">
            ...
            <view class="dir-left-nowrap cross-center cash-type" @click="cashTypeModel = true">
                ...
                <image class="box-grow-0 arrow-image" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png"></image>
            </view>
...
<style scoped lang="scss">
    ...
    .cash-type-item {
        ...
        .cash-type-box {
            ...
            .radio-single-active {
                ...
                background-image: url("https://cashier.qicuo.com/app/static/image/icon/icon-checkbox-checked-a.png");
            }
        }
    ...
    .cash-process {
        ...
        .icon.wechat {
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/cash/icon-wechat.png");
        }

        .icon.alipay {
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/cash/icon-alipay.png");
        }

        .icon.bank {
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/cash/icon-bank.png");
        }

        .icon.balance {
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/cash/icon-balance.png");
        }

        .icon.auto {
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/cash/icon-auto.png");
        }
    }
