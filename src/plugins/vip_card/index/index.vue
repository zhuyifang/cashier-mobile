<template>
    <app-layout>
            ...
            <view>
                ...
                <view v-if="list.is_agreement" class="bottom-read main-center cross-bottom">
                    <view @click="toRead" class="read-icon main-center cross-bottom">
                        ...
                        <image v-else src="https://cashier.qicuo.com/app/static/image/icon/form-er.png" alt=""></image>
                    </view>
        ...
        <view v-if="title && content" class="bg main-center cross-center">
            <view class="dialog">
                <image @click="lookAbout" class="dialog-close" src="https://cashier.qicuo.com/app/static/image/icon/icon-close.png"></image>
        ...
        <view v-if="showLog" class="bg main-center cross-center">
            <view class="dialog buy-log">
                ...
                <image @click="toggleLog" class="dialog-close" src="https://cashier.qicuo.com/app/static/image/icon/icon-close.png"></image>
