	        ...
	        <view class='other' :style="{'background':`linear-gradient(to bottom,${customize.end_bg},${customize.end_style == 1 ? customize.end_gradient_bg : customize.end_bg})`,'min-height':`${other_height}`}">
	            <view class='reward' v-if="config.continue.length > 0">
	                <view :class="[`reward-item`, `${item.day == config.continue[0].day ? 'no-top':''}`]" v-for="(item, index) in config.continue" :key="index" :style="{'border-color':`${customize.line_font}`}">
	                    <image load-lazy='true' class='reward-icon' v-if="item.type =='integral'" :src="customize.integral_icon ? customize.integral_icon : 'https://cashier.qicuo.com/app/static/image/integral.png'"></image>
	                    <image load-lazy='true' class='reward-icon' v-if="item.type =='balance'" :src="customize.balance_icon ? customize.balance_icon : 'https://cashier.qicuo.com/app/static/image/hongbao.png'"></image>
	                ...
	                <view class='day-title main-center cross-center'>
	                    <view @click="lose">
	                    	<view class="toggle-btn main-center cross-center">
	                        	<image load-lazy='true' src='https://cashier.qicuo.com/app/static/image/icon/arrow-left.png'></image>
	                    	</view>
	                    </view>
	                    <view class='date'>
	                        <text>{{year}}</text>
	                    ...
	                    <view @click="add">
	                    	<view class="toggle-btn main-center cross-center">
	                        	<image load-lazy='true' src='https://cashier.qicuo.com/app/static/image/icon/arrow-right.png'></image>
	                    	</view>
	                    </view>
	                </view>
	    ...
	    <view class='dialog' v-if="success || getRed">
	        <view v-if="success" class='success'>
	            ...
	            <view class='getPrice main-center'>
	                <image load-lazy='true' v-if="result.type == 'integral'" :src="customize.integral_icon ? customize.integral_icon : 'https://cashier.qicuo.com/app/static/image/integral.png'"></image>
