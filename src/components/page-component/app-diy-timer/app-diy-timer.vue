<template>
    <view class="app-timer">
        <app-jump-button form :url="link.url" :open_type="link.openType" arrangement="column">
            ...
            <view :style="{'background-image':  `url(${bgPicUrl ? bgPicUrl : 'https://cashier.qicuo.com/app/static/image/icon/icon-timer-bg.png'})`}" class="timer dir-top-nowrap main-center"
                  v-if="timerStr">
