    ...
    .app-goods-poster-two {
        ...
        .box {
            ...
            .end-bg {
                height: #{616rpx};
                width: #{702rpx};
                background-image: url("https://cashier.qicuo.com/app/static/image/poster/style-two-end-shadow.png");
                ...
                .end-info {
                    ...
                    .icon-three-arrow {
                        height: #{17rpx};
                        width: #{15rpx};
                        background-image: url("https://cashier.qicuo.com/app/static/image/poster/three-arrow.png");
                        background-size: 100% 100%;
                        background-repeat: no-repeat;
                        margin-left: #{10rpx};
                    }
