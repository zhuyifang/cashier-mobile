    ...
    export default {
	    ...
	    props: {
            ...
            goodsTagPicUrl: {
                type: String,
	            default: function() {
	                return 'https://cashier.qicuo.com/plugins/diy/assets/images/goods-tag-rx.png';
	            }
            },
...
<style scoped lang="scss">
	...
	.app-recommended-product {
		...
		.app-shopping-cart {
			background-image: url("https://cashier.qicuo.com/app/static/image/icon/shopping-cart.png");
		}
		.app-add-to {
