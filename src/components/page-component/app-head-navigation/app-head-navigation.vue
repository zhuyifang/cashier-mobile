	...
	<view class="bd-nav">
        ...
        <view class="bd-head dir-left-nowrap">
            ...
            <view class="bd-btn" @click="isSwitch = true">
                <image class="bd-bt-img" src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"></image>
            </view>
        </view>
        <view class="bd-content" v-if="isSwitch" @touchmove.stop.prevent>
            <view class="bd-head dir-left-nowrap">
                ...
                <view class="bd-btn" @click="isSwitch = false">
                    <image class="bd-bt-img" src="https://cashier.qicuo.com/app/static/image/icon/icon-up.png"></image>
                </view>
            </view>
