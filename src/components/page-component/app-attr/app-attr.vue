	   ...
	   <view class="modal" v-if="display === 'block'"  @click="close" >
		   <view class="safe-area-inset-bottom u-attr-fixed" >
			   <view class="content" @tap.native.stop="preventD">
				   <image src="https://cashier.qicuo.com/app/static/image/icon/close.png" class="close" @click="close"></image>
				   ...
				   <view class="second" :class="sign ==='wholesale' ? 'no-padding' : ''">
                        ...
                        <view class="wholesale" v-if="sign ==='wholesale'">
                            <view class="wholesale-attr-list dir-left-nowrap cross-center" v-if="index != goods.attr_groups.length -1" v-for="(item, index) in goods.attr_groups" :key="index">
                                ...
                                <view @click.stop="toBottom(index)" class="right-icon">
                                    <view></view>
                                    <image src="https://cashier.qicuo.com/app/static/image/icon/right.png"></image>
                                </view>
                            </view>
                                   ...
                                   <view class="dir-left-nowrap">
                                        <view class="wholesale-attr-item main-between">
                                            ...
                                            <view class="dir-left-nowrap wholesale-number-box cross-center">
                                               <image :src="item.number <= 0 ? 'https://cashier.qicuo.com/app/static/image/plugins/un-low.png' : 'https://cashier.qicuo.com/app/static/image/plugins/low.png'" class="block box-grow-0 cross-center main-center" @click.stop="wholesaleNumberSub(index)">
                                               </image>
                                               ...
                                               <image :src="item.number >= item.stock? 'https://cashier.qicuo.com/app/static/image/plugins/un-add.png' : 'https://cashier.qicuo.com/app/static/image/plugins/add.png'" class="block box-grow-0 cross-center main-center" @click.stop="wholesaleNumberAdd(index)"></image>
                                            </view>
                                        </view>
                                   </view>
                               </view>
					   ...
					   <view v-if="chooseNumber" class="dir-left-nowrap number-box cross-center">
						   ...
						   <image :src="number <= 1 ? 'https://cashier.qicuo.com/app/static/image/icon/can-be-reduced.png' : 'https://cashier.qicuo.com/app/static/image/cart/can-be-reduced.png'" class="block box-grow-0 cross-center main-center" @click.stop="numberSub">
						   </image>
						   ...
						   <image src="https://cashier.qicuo.com/app/static/image/cart/can-be-added.png" class="block box-grow-0 cross-center main-center" @click.stop="numberAdd"></image>
					   </view>
				   </view>
                ...
                if (this.goods.sign === 'miaosha') {
                    ...
                    if(this.totalNumber < this.goods.wholesaleGoods.rise_num) {
                        uni.showToast({
                            ...
                            image: 'https://cashier.qicuo.com/app/static/image/plugins/tip.png',
                            duration: 1000
                        });
                        return false
                    }
