...
<style scoped lang="scss">
	.app-coupon-center {
		...
		.app-coupon-item {
			...
			.app-unexpired {
				background-image: url("https://cashier.qicuo.com/app/static/image/icon/unexpired-coupon.png");
			}
			.app-received {
				background-image: url("https://cashier.qicuo.com/app/static/image/icon/received-coupon.png");
			}
			.app-bottom {
				width: #{702rpx};
				height: #{112rpx};
