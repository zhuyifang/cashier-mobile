...
<style scoped lang="scss">
    ...
    .app-quick-navigation {
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/quick-navigation.png");
    }

    .app-collapse {
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/collapse.png");
    }
