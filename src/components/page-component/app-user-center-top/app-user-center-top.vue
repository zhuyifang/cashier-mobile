        ...
        <view class="style-3 box-grow-1 main-center" v-if="topStyle == '3'">
            <view class="style-3-container dir-left-nowrap cross-center"
                ...
                <view class="box-grow-0 avatar-container">
                    ...
                    <image v-if="is_vip_card_user && is_icon_super_vip == '1'" src="https://cashier.qicuo.com/app/static/image/vip_icon.png" class="vip_icon"></image>
                </view>
                ...
                <view class="box-grow-0 address-container">
                    <app-jump-button v-if="userInfo && userInfo.is_show_pay_code" form url="/plugins/teller/index/index">
                        <view class="address-btn-3 pay-code">
                            <image class="pay-code-icon" src="https://cashier.qicuo.com/app/static/image/icon/pay-code.png"></image>
                            <view>付款码</view>
                        </view>
                    </app-jump-button>
                    <app-jump-button form url="/pages/address/address">
                        <view class="address-btn-3">
                            <image class="address-btn-icon" src="https://cashier.qicuo.com/app/static/image/icon/address-white.png"></image>
                            <view>收货地址</view>
                        </view>
                    </app-jump-button>
                </view>
        ...
        computed: {
            ...
            avatar() {
                if (this.isLogin && this.userInfo) {
                    ...
                    return 'https://cashier.qicuo.com/app/static/image/user-default-avatar.png';
                }
            },
            getMemberPicUrl() {
...
<style scoped lang="scss">
    ...
    .u-refresh {
        ...
        .u-icon {
            width: 21upx;
            height: 21upx;
            background-image: url('https://cashier.qicuo.com/app/static/image/icon/refresh.png');
            background-size: 100% 100%;
            background-repeat: no-repeat;
            margin-right: 5upx;
        }
