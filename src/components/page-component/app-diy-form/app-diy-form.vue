        ...
        <view :style="{
                      ...
                      'margin-bottom': `${itemMarginY}rpx`,
                        ...
                        <view v-if="labelPosition !== 'inset'" class="box-grow-0 cross-top label">
                            <image v-if="showRequiredIcon && (item.is_required == 1 || item.is_required == '1')"
                                   class="required-icon"
                                   src="https://cashier.qicuo.com/app/static/image/icon/required.png"></image>
                            <view class="name-key"
                        ...
                        padding: labelPosition === 'top' ? `12rpx 0` : `12rpx 12rpx`,
                            ...
                            <template v-if="item.img_type == 2">
                                <app-upload-image
                                        ...
                                        text="身份证正面"
                                        :show-number="false"
                                        default-img="https://cashier.qicuo.com/app/static/image/user-id-card-front.png"></app-upload-image>
                                <app-upload-image
                                        ...
                                        text="身份证反面"
                                        :show-number="false"
                                        default-img="https://cashier.qicuo.com/app/static/image/user-id-card-back.png"></app-upload-image>
                            </template>
                            ...
                            <template v-if="item.img_type == 3">
                                <app-upload-image
                                        ...
                                        text="营业执照"
                                        :show-number="false"
                                        default-img="https://cashier.qicuo.com/app/static/image/company-license.png"></app-upload-image>
                            </template>
                        </view>
                    </view>
            ...
            <view class="main-center cross-center scroll-bar" v-if="showScrollBtn"
                ...
                <view class="cross-center">
                    <image v-if="showAllItems" src="https://cashier.qicuo.com/app/static/image/icon/icon-up.png"
                           style="width: 18rpx;height: 10rpx;"></image>
                    <image v-else src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"
                           style="width: 18rpx;height: 10rpx;"></image>
                </view>
            </view>
