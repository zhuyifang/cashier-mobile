        ...
        <view class="u-notice-bar" :style="{backgroundColor: bgColor}" @click="take(true)">
            <view class="u-direction-row">
                <view class="u-icon-wrap">
                    <image class="u-icon-left" :src="icon ? icon : 'https://cashier.qicuo.com/app/static/image/icon/icon-notice.png'"></image>
                ...
                <view class="u-icon-wrap">
                    <image class="u-icon-right" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right-white.png" ></image>
                </view>
            </view>
        </view>
...
<style lang="scss" scoped>
    ...
    .app-top-image {
        ...
        &.icon {
            background-image: url("https://cashier.qicuo.com/app/static/image/icon/announcement.png");
        }
    }
   	.u-bottom-content {
