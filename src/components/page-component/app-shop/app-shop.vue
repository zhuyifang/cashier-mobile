		...
		<view class="app-item dir-left-nowrap main-between cross-center" v-for="(item, index) in newList" :key="index">
						...
						<view class="app-score dir-left-nowrap main-left" v-if="showScore">
							...
							<view class="app-love">
                                <image
                                    ...
                                    :key="index"
                                    :src="scorePicUrl ? scorePicUrl : 'https://cashier.qicuo.com/app/static/image/icon/store-score.png'"
                                ></image>
							</view>
						</view>
			...
			<view class="app-jump">
				<app-jump-button open_type="map" arrangement="column" form backgroundColor="white" :latitude="item.latitude" :longitude="item.longitude">
					<image :src="navPicUrl ? navPicUrl : 'https://cashier.qicuo.com/app/static/image/icon/navigation.png'" class="scorePicUrl app-icon image-no-rep image-cover"></image>
