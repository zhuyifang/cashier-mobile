        ...
        computed: {
            ...
            couponBgImg() {
                ...
                switch (this.coupon_list.length) {
                    case 1:
                        return 'https://cashier.qicuo.com/app/static/image/diy/bg_coupon_index_1.png';
                    case 2:
                        return 'https://cashier.qicuo.com/app/static/image/diy/bg_coupon_index_2.png';
                    case 3:
                        return 'https://cashier.qicuo.com/app/static/image/diy/bg_coupon_index_3.png';
                    default:
                        return 'https://cashier.qicuo.com/app/static/image/diy/bg_coupon_index_4.png';
                }
            },
