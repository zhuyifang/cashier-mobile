<template>
    <view class="app-index-wholesale">
        <view class="top dir-left-nowrap cross-center" @click="jump(`/plugins/wholesale/index/index`)">
            <image class="box-grow-0" src='https://cashier.qicuo.com/app/static/image/icon/wholesale.png"></image>
            <view class="box-grow-1">商品批发</view>
            <view class="dir-left-nowrap cross-center">
                <view class="box-grow-0 more">更多</view>
                <image class="box-grow-0 icon" src='https://cashier.qicuo.com/app/static/image/icon/arrow-right.png"></image>
            </view>
        </view>
