            ...
            <view slot="content">
                <view class="dir-top-nowrap">
                    <view class="cash-type-item dir-left-nowrap cross-center" v-if="isAuto">
                        <image class="icon" src="https://cashier.qicuo.com/app/static/image/icon/cash/icon-auto.png"></image>
                    ...
                    <view class="cash-type-item dir-left-nowrap cross-center" v-if="isWx">
                        <image class="icon" src="https://cashier.qicuo.com/app/static/image/icon/cash/icon-wechat.png"></image>
                    ...
                    <view class="cash-type-item dir-left-nowrap cross-center" v-if="isAlipay">
                        <image class="icon" src="https://cashier.qicuo.com/app/static/image/icon/cash/icon-alipay.png"></image>
                        <view class="dir-left-nowrap cross-center box-grow-1 cash-type-box"
                    ...
                    <view class="cash-type-item dir-left-nowrap cross-center" v-if="isBank">
                        <image class="icon" src="https://cashier.qicuo.com/app/static/image/icon/cash/icon-bank.png"></image>
                        <view class="dir-left-nowrap cross-center box-grow-1 cash-type-box"
                    ...
                    <view class="cash-type-item dir-left-nowrap cross-center" v-if="isBalance">
                        <image class="icon" src="https://cashier.qicuo.com/app/static/image/icon/cash/icon-balance.png"></image>
                        <view class="dir-left-nowrap cross-center box-grow-1 cash-type-box"
