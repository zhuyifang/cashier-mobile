<template>
  <view class="bd-info">
            ...
            <template v-if="levelShow === 1">
              <view class="dir-left-wrap cross-bottom">
                <view class="bd-price box-grow-0" :style="{'color': theme.color}">
                  <app-price :max="`${priceMemberMax}`" :min="`${priceMemberMin}`" :default-price="`${price}`"
                             :theme="theme"></app-price>
                </view>
              ...
              <view class="dir-left-nowrap cross-bottom">
                <view v-if="isUnderlinePrice == 1" :style="{'color': theme.color}"
                      class="'box-grow-0', 'bd-member-price'">
      ...
      <template v-if="isShowShare">
        <view class="box-grow-0 bd-share">
          <view @click="shareClick"
            ...
            <image class="bd-icon box-grow-0" src="https://cashier.qicuo.com/app/static/image/icon/icon-share-white.png"></image>
    ...
    <slot></slot>
    <bd-info-extra :theme="theme" :min-number="minNumber" :limit-buy="limitBuy" :goods="goods"
                   :unit="unit"></bd-info-extra>
    ...
    <view class="bd-margin bd-procedure" v-if="isProcess">
      <image class="process" src="https://cashier.qicuo.com/app/static/image/procedure.png"></image>
    </view>
  </view>
</template>
