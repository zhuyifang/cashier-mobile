        ...
        <cover-view v-if="friendModel" class="friend-box">
            <cover-view class="info main-center cross-center dir-top-nowrap">
                <cover-view class="dir-left-nowrap cross-center">
                    <cover-image src="https://cashier.qicuo.com/app/static/image/icon/friend-v.png" class="icon"></cover-image>
...
.goods-set {
    ...
    .video-number {
        margin-left: #{20rpx};
        background-image: url("https://cashier.qicuo.com/app/static/image/icon/video-number-2.png");
    }
