	...
	<view>
		<view class="search" @click="router">
			<view class="f-input dir-left-nowrap main-center cross-center">
				<image src="https://cashier.qicuo.com/app/static/image/icon/search.png"></image>
				<text>搜索</text>
			</view>
		</view>
		<form report-submit v-on:submit="getFormId">
			<view class="page-width sort-rule dir-left-nowrap">
				...
				<button @click="setStyle" class="box-grow-1 item dir-top-nowrap main-center cross-center">
					<image class="img-icon"  :src="listStyle ? 'https://cashier.qicuo.com/app/static/image/icon/square.png' : 'https://cashier.qicuo.com/app/static/image/icon/row.png'"  ></image>
				</button>
			</view>
		</form>
	</view>
...
<style scoped lang="scss">
	...
	.default {
		background-image: url('https://cashier.qicuo.com/app/static/image/icon/price-sort-default.png');
	}
	.tall {
		background-image: url('https://cashier.qicuo.com/app/static/image/icon/tall.png');
	}
	.low {
		background-image: url('https://cashier.qicuo.com/app/static/image/icon/low.png');
	}
	.search {
		height: 93upx;
