        ...
        <view class="modal" v-if="payData">
            <view class="title">
                ...
                <view class="cancel" @click="cancel">
                    <image src="https://cashier.qicuo.com/app/static/image/icon/close.png"></image>
                </view>
            </view>
                ...
                <view v-for="(item, index) in payData.list"
                    ...
                    <view class="box-grow-0">
                        <view v-if="item.key === 'balance' && item.desc === '账户余额不足'"
                            ...
                            <image style="height: 100%;width:100%" load-lazy="true"
                                   src="https://cashier.qicuo.com/app/static/image/pay-td.png"></image>
                        </view>
                    ...
                    <view class="into-modal main-center cross-center" v-if="printPassword && item.key === 'balance'">
                        ...
                        <view class="password-view" v-else-if="printPassword">
                            <image class="password-close" @click="printPassword = false;setPassword = false;verifyPassword = false;" src="https://cashier.qicuo.com/app/static/image/icon/icon-close.png"></image>
