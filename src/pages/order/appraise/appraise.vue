                        ...
                        <view class='box-grow-1 dir-left-nowrap cross-center'>
                            ...
                            <view class="box-grow-0" @click='checkedChange(item)'>
                                <image v-if='item.is_anonymous' class='check-icon'
                                       src='https://cashier.qicuo.com/app/static/image/icon/order/icon-checkbox-checked.png'></image>
                                <image v-else class='check-icon' src='https://cashier.qicuo.com/app/static/image/icon/form-er.png'></image>
                            </view>
