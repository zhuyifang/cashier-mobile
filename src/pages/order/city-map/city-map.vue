    ...
    data() {
        return {
            ...
            covers: [{
                ...
                latitude: 0,
                longitude: 0,
                iconPath: 'https://cashier.qicuo.com/app/static/image/icon/city-service/my.png',
                width: 50,
                height: 50
            },
            {
                latitude: 0,
                longitude: 0,
                iconPath: 'https://cashier.qicuo.com/app/static/image/icon/city-service/shop.png',
                width: 50,
                height: 50
            }],
            express_id: 0,
