    ...
    <app-layout>
        <view class="search-mode">
            <view class="search-input">
                ...
                <image v-if="keyword.length > 0" @click="clearSearch" class="search-clear" src="https://cashier.qicuo.com/app/static/image/icon/clear.png"></image>
            </view>
            <view class="search-time dir-left-nowrap cross-center">
                ...
                <view @click="dialog=true;type=1" class="search-time-item main-between cross-center" :class="{'placeholder': !start}">
                    ...
                    <image v-if="start" @click.stop="clearTime(1)" class="time-clear" src="https://cashier.qicuo.com/app/static/image/icon/clear.png"></image>
                </view>
                ...
                <view @click="dialog=true;type=2" class="search-time-item main-between cross-center" :class="{'placeholder': !end}">
                    ...
                    <image v-if="end" @click.stop="clearTime(2)" class="time-clear" src="https://cashier.qicuo.com/app/static/image/icon/clear.png"></image>
                </view>
            </view>
            <view>
               <app-iphone-x>
