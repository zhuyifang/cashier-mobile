               ...
               <app-iphone-x>
                   <view class="bar dir-left-nowrap cross-center" slot="empty-area">
                       <view class="box-grow-1 dir-top-wrap cross-center" v-if="topic.is_favorite === 'love'" @click="favorite">
                           <image src="https://cashier.qicuo.com/app/static/image/icon/icon-favorite-active.png"></image>
                           <view>已收藏</view>
                       </view>
                       ...
                       <view class="box-grow-1 dir-top-wrap cross-center" @click="shareClick">
                           <image src="https://cashier.qicuo.com/app/static/image/icon/icon-share-gray.png"></image>
                           <view>分享</view>
                       </view>
                   </view>
               </app-iphone-x>
