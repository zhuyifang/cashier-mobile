            ...
            <view class="item" v-for="item in list" :key="item.id">
                ...
                <view @click="open(item.id)">
                    <view class="item-bottom dir-left-nowrap">
                        ...
                        <image class="close" src="https://cashier.qicuo.com/app/static/image/share/img-share-down.png" v-if="id == item.id"></image>
                        <image class="open" src="https://cashier.qicuo.com/app/static/image/share/img-share-right.png" v-else></image>
                    </view>
                </view>
