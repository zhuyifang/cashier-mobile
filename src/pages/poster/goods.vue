    ...
    data() {
        return {
            ...
            typesettingList: [{
                label: '1张图',
                    value: 1,
                    pic_url: 'https://cashier.qicuo.com/app/static/image/poster/pic-one.png'
                }, {
                    label: '2张图',
                    value: 2,
                    pic_url: 'https://cashier.qicuo.com/app/static/image/poster/pic-two.png'
                }, {
                    label: '3张图',
                    value: 3,
                    pic_url: 'https://cashier.qicuo.com/app/static/image/poster/pic-three.png'
                }, {
                    label: '4张图',
                    value: 4,
                    pic_url: 'https://cashier.qicuo.com/app/static/image/poster/pic-four.png'
                }, {
                    label: '5张图',
                    value: 5,
                    pic_url: 'https://cashier.qicuo.com/app/static/image/poster/pic-five.png'
                }],
                typeList: [],
                colorList: [],
                selectForm: null,
        ...
        .setting {
            ...
            .line {
                ...
                .label {
                    ...
                    icon {
                        background-image: url("https://cashier.qicuo.com/app/static/image/poster/mark.png");
            ...
            .icon-active {
                background-image: url("https://cashier.qicuo.com/app/static/image/poster/input-active.png");
                height: #{38rpx};
                width: #{38rpx};
                background-repeat: no-repeat;
                background-size: 100% 100%;
