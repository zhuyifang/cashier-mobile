<template>
    <app-layout>
        ...
        <view class="cross-center tel">
            ...
            <image @click="mobile" class="box-grow-0" src="https://cashier.qicuo.com/app/static/image/icon/store-tel.png"></image>
        </view>
        <view class="cross-top address">
            <view class="box-grow-0">地址：</view>
            <view class="box-grow-1 info">{{list.address}}</view>
            <image @click="goto" class="box-grow-0" src="https://cashier.qicuo.com/app/static/image/icon/store-navigate.png"></image>
        </view>
    ...
    .head {
        ...
        .score {
            ...
            .image {
                ...
                background-image: url('https://cashier.qicuo.com/app/static/image/icon/store-score.png');
                margin-left: #{6rpx};
                height: #{24rpx};
                width: #{28rpx};
            }
