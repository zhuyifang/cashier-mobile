            ...
            <view class="f-set" catchtouchmove="true">
                <view class="f-status dir-left-nowrap cross-center" :style="{'transform':'translateY(' + statusTop + 'rpx)'}">
                    ...
                    <view class="f-good-icon" @click="setListStyle()">
                        <image
                           :src="listStyle ? 'https://cashier.qicuo.com/app/static/image/icon/favorite/square.png' : 'https://cashier.qicuo.com/app/static/image/icon/favorite/row.png'"></image>
                    </view>
                </view>
                                ...
                                <view class="f-content dir-top-wrap main-between">
                                    ...
                                    <view>
                                        <view class="f-invalid dir-left-nowrap cross-center main-between"
                                            ...
                                            <image src="https://cashier.qicuo.com/app/static/image/icon/invalid.png"></image>
                                            <text>失效</text>
                                        </view>
                                        <view class="f-low-stock dir-left-nowrap cross-center main-between"
                                              v-if="item.status_type === 2">
                                            <image src="https://cashier.qicuo.com/app/static/image/icon/low_stock.png"></image>
                                            <text>低库存</text>
                                        </view>
                                        <view class="f-low-price dir-left-nowrap"
                                              v-if="item.status_type === 1">
                                            <view class="dir-left-nowrap main-between cross-center">
                                                <image src="https://cashier.qicuo.com/app/static/image/icon/low_price.png"></image>
...
.bd-image {
    background-image:url("https://cashier.qicuo.com/app/static/image/icon/favorite/bottom.png");
