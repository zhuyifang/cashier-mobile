<template>
    <view class="page">
        <view class="view" v-if="list">
            <view class='card'>
                ...
                <view class="dir-left-nowrap main-center" v-if="list.status == 0">
                    <view class="over over-lg dir-left-nowrap cross-top box-grow-0">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/icon_ok.png" class="icon_ok box-grow-0"></image>
                        <view class="box-grow-1" style="height: 100%;">
                            <view>已转赠给：{{list.receive_user_name}}</view>
                        </view>
                        <image src="https://cashier.qicuo.com/app/static/image/card/img_seal.png" class="img_seal"></image>
                    </view>
                </view>
            ...
            <view class='line'>
                <image src='https://cashier.qicuo.com/app/static/image/icon/line.png'></image>
            </view>
