                ...
                <view class="app-content" :style="{'margin-bottom': good.sign === 'wholesale' ? good.new_status == 0 || good.new_status == 6 ?'0' : '50rpx' : '30rpx'}">
                    <view class="app-wholesale-title" v-if="good.sign === 'wholesale'" :class="{'app-failed-title': good.new_status !== 0 && !(good.new_status == 6 && good.sell_time > 0)}">
                        ...
                        <view class="rise-num dir-left-nowrap cross-center" :style="{'color': `${good.new_status !== 0 && good.new_status !== 6 ? '#999999' : good.new_status === 0 ? '#63be72': '#ff4544'}`}">
                            <image v-if="good.new_status !== 0 && good.new_status !== 6" class="num-icon" src="https://cashier.qicuo.com/app/static/image/icon/grey.png"></image>
                            <image v-else-if="good.new_status === 0" class="num-icon" src="https://cashier.qicuo.com/app/static/image/icon/friend-v.png"></image>
    ...
    .app-mch {
        ...
        .app-all-radio {
            ...
            .app-all-active {
                ...
                background-image: url("https://cashier.qicuo.com/app/static/image/icon/yes-radio.png");
            }
        }
        .app-mch-name {
            max-width: #{522rpx};
        ...
        .app-content {
            ...
            .app-miaosha {
                ...
                .app-miaosha-icon {
                    ...
                    background-size: 100% 100%;
                    background-image: url("https://cashier.qicuo.com/app/static/image/cart/miaosha.png");
                    margin-right: #{12rpx};
                }
                .app-flash-sale-icon {
                    width: #{29rpx};
                    ...
                    background-repeat: no-repeat;
                    background-size: 100% 100%;
                    background-image: url("https://cashier.qicuo.com/app/static/image/plugins/flash-sale-icon.png");
                    margin-right: #{12rpx};
                }
                ...
                .app-spike-icon {
                    ...
                    background-repeat: no-repeat;
                    background-size: 100% 100%;
                    background-image: url("https://cashier.qicuo.com/app/static/image/cart/spike-invalid.png");
                    margin-right: #{12rpx};
                }
                .app-beginning {
                    font-size: #{22rpx};
