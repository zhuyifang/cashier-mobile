	...
	<app-layout :overflow='false'>
		<view class="app-cart">
			...
			<view class="no-cart" v-if="listObj.length === 0">
				<view class="cart-icon">
					<image class="cart-image" src="https://cashier.qicuo.com/app/static/image/icon/nav-icon-cart.png"></image>
				</view>
        ...
        <view @touchmove.stop.prevent="" class="send-dialog" @click="sendDialog=false" v-if="sendDialog">
            <view class="send-content" @click.stop="">
                <image class="send-close" @click="sendDialog=false" src="https://cashier.qicuo.com/app/static/image/icon/icon-close.png"></image>
                ...
                <view class="send-type" v-if="countList.express.number > 0">
                    <view class="send-type-name dir-left-nowrap cross-center">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/express.png"></image>
                ...
                <view class="send-type" v-if="countList.city.number > 0">
                    <view class="send-type-name dir-left-nowrap cross-center">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/city.png"></image>
                ...
                <view class="send-type" v-if="countList.offline.number > 0">
                    <view class="send-type-name dir-left-nowrap cross-center">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/offline.png"></image>
