        ...
        <view class="page" v-if="card">
            <view class="main-card"
                ...
                <view class="dir-left-nowrap cross-center">
                    <image src="https://cashier.qicuo.com/app/static/image/icon/vip-card-coupon.png"
                    ...
                    <template v-if="card.is_free_delivery == 1 || true">
                        <image src="https://cashier.qicuo.com/app/static/image/icon/vip-card-delivery.png"
