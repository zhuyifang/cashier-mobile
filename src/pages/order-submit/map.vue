        ...
        <view class="map" v-if="config && config.address">
            ...
            <cover-view class="bottom dir-left-nowrap" :style="{paddingBottom: iPhoneX.XBoolean ? '50rpx' : '24rpx'}">
                ...
                <cover-view class="box-grow-0 cross-center" @click="mobile">
                    <cover-image class="mobile" src="https://cashier.qicuo.com/app/static/image/icon/store-tel.png"></cover-image>
                </cover-view>
            </cover-view>
        </view>
    </app-layout>
            ...
            markers() {
                ...
                if (this.config && this.config.range && this.config.address) {
                    markers.push({
                        ...
                        // #endif
                        iconPath: 'https://cashier.qicuo.com/app/static/image/location.png',
                        width: 20,
                        height: 20,
                    })
                }
