        ...
        <view class="page">
            <view class="search">
                <view class="prompt dir-left-nowrap main-center cross-center" v-if="search" @click="search = false">
                    <image src="https://cashier.qicuo.com/app/static/image/icon/icon-search.png"></image>
                ...
                <view v-else style="position: relative">
                    ...
                    <image v-if="getFocus && keyword.length" @click.stop="keyword = ''" class="search-clear"
                           src="https://cashier.qicuo.com/app/static/image/icon/delete-yuan.png"></image>
                </view>
            </view>
                        ...
                        <app-form-id>
                            <app-button :theme="getTheme" type="important" round @click="editAddress(0)">
                                <view class="cross-center main-center">
                                    <image class="icon" src="https://cashier.qicuo.com/app/static/image/icon/add.png"></image>
                                    <view>手动添加</view>
                                </view>
                            </app-button>
                        </app-form-id>
                    ...
                    <view class="box-grow-1" v-if="type === 0">
                        <app-form-id>
                            <app-button type="important" round background="#08c303"
                                ...
                                <view class="cross-center main-center">
                                    <image class="icon" src="https://cashier.qicuo.com/app/static/image/icon/wechat-white.png"></image>
                                    <view>自动获取</view>
                                </view>
                            </app-button>
                        </app-form-id>
