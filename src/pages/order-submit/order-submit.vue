              ...
              <view :key="mchIndex" class="group">
                ...
                <view style="padding: 26rpx 32rpx;">
                  <view class="dir-left-nowrap cross-center" style="padding: 10rpx 0;line-height: 1.2;">
                    ...
                    <view class="box-grow-0">
                      <image src="https://cashier.qicuo.com/app/static/image/icon/store-black.png" class="title-icon mr-12"></image>
                    </view>
                    ...
                    <view v-if="mch.mch.id > 0 &&  mch.delivery && mch.delivery.send_type === 'offline' && mch.store && mch.store.distance != '-m'" class="box-grow-0 dir-left-nowrap cross-center">
                      <image src="https://cashier.qicuo.com/app/static/image/icon/location.png" class="mr-12" style="display: block; width: 22rpx;height: 26rpx;"></image>
                    ...
                    <template v-else>
                      <template v-if="mch.store">
                        <view v-if="mch.mch.id == 0" class="dir-left-nowrap" style="padding: 10rpx 0;line-height: 1.2;">
                          <view @click="navigateStore(mchIndex)" class="box-grow-1 dir-left-nowrap cross-center">
                            <view>
                              <image src="https://cashier.qicuo.com/app/static/image/icon/navigation-black.png" class="title-icon mr-12"></image>
                            </view>
                            <view class="font-bold ellipsis-1 mr-12">
                              {{mch.store.name}}
                            </view>
                            <view class="mr-12">
                              <image src="https://cashier.qicuo.com/app/static/image/icon/right.png" class="mr-12" style="width: 12rpx; height: 22rpx;"></image>
                            </view>
                          </view>
                      ...
                      <view v-else class="dir-left-nowrap cross-center" @click="navigateStore(mchIndex)" style="padding: 10rpx 0;">
                        ...
                        <view class="box-grow-0 dir-left-nowrap cross-center">
                          ...
                          <image src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png" class="mr-12" style="width: 12rpx; height: 22rpx;"></image>
                        </view>
                      </view>
                    </template>
                  </template><!-- 自提门店信息end -->
                ...
                <view v-if="mch.show_delivery !== false" style="padding: 18rpx 32rpx;">
                  ...
                  <view class="dir-left-nowrap cross-center" style="padding: 18rpx 0;">
                    <view class="box-grow-0">
                      <image src="https://cashier.qicuo.com/app/static/image/icon/delivery.png" class="title-icon mr-12"></image>
                    </view>
                ...
                <template v-if="(mch.coupon && mch.coupon.enabled) ||
                        ...
                        <view style="padding: 20rpx 32rpx;">
                            <template v-if="mch.coupon && mch.coupon.enabled">
                                <view @click="showCouponPicker(mchIndex)" style="padding: 16rpx 0;">
                                    <view class="dir-left-nowrap cross-center">
                                        ...
                                        <view class="box-grow-0">
                                            <image src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png" style="width: 12rpx; height: 22rpx; margin-bottom: -2rpx;"></image>
                                        </view>
                                    </view>
                                </view>
                            ...
                            <view v-if="mch.integral && mch.integral.can_use" class="dir-left-nowrap" style="padding: 16rpx 0;">
                                <view class="box-grow-1 dir-left-nowrap cross-center">
                                    ...
                                    <image @click="showIntegralTip" style="width: 36rpx;height: 36rpx; margin: -12rpx 0;" src="https://cashier.qicuo.com/app/static/image/icon/warning.png"></image>
                                </view>
                                <view class="box-grow-0 dir-left-nowrap cross-center">
                        ...
                        <view class="box-grow-1">
                          ...
                          <template v-else>
                            ...
                            <view @click="navigateVipCardPrivilege" class="dir-left-nowrap cross-center">
                              ...
                              <image src="https://cashier.qicuo.com/app/static/image/icon/order-submit/arrow-right-b.png" style="width: 12rpx;height: 22rpx; display: block;"></image>
                            </view>
                          </template>
                        </view>
                        <view class="box-grow-0 dir-left-nowrap cross-center" style="padding: 12rpx 22rpx 12rpx 0;" @click="navigateSvip(mchIndex)">
                          ...
                          <image src="https://cashier.qicuo.com/app/static/image/icon/order-submit/arrow-right-a.png" style="width: 12rpx;height: 22rpx; display: block;"></image>
                        </view>
                      </view>
                    </view>
                    <view v-if="mch.insert_rows && mch.insert_rows.length" :class="[mch.showInsertRows?'show':'',]">
                      <view class="dir-left-nowrap cross-center" @click="reversalShowInsertRows(mchIndex)" style="padding: 16rpx 0;">
                        <view class="box-grow-1 dir-left-nowrap cross-center">
                          ...
                          <image style="width: 22rpx; height: 12rpx;" class="bottom-icon" src="https://cashier.qicuo.com/app/static/image/icon/bottom.png"></image>
                        </view>
                        <view class="box-grow-0"  :class="[themeTextClass]" :style="{'color': !is_gift ? theme.color : ''}">
