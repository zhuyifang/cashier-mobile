    ...
    <app-layout>
        ...
        <view v-if="search" class="search-item main-between cross-center">
            <view class="search-input">
                <image class="search-icon" src='https://cashier.qicuo.com/app/static/image/icon/icon-search.png'></image>
        ...
        <view v-if="!searchResult && search && list.length === 0" class="search-history">
            <view v-if="candidate.length !== 0" class='main-between search-title'>
                <view>历史搜索</view>
                <view @click="clear">
                    <image class="delete-icon" src="https://cashier.qicuo.com/app/static/image/icon/delete.png"></image>
                </view>
            </view>
        ...
        <view v-if="!search" class="search-area main-between cross-center">
            <view class="search main-center" @click="toSearch">
                <image class="icon-search" src="https://cashier.qicuo.com/app/static/image/icon/icon-search.png"></image>
                <text>搜索</text>
            </view>
