	...
	<app-layout>
        <view class="info">
            ...
            <view @click="choose(1)" class="dir-left-nowrap form-item" :class="change ? 'change-item' : ''">
                ...
                <image v-if="change && show_dialog && dialog_title == '选择代理级别'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-up.png"></image>
                <image v-if="change && dialog_title != '选择代理级别'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"></image>
            </view>
            <view @click="choose(2)" class="dir-left-nowrap form-item" :class="change ? 'change-item' : ''">
                ...
                <image v-if="change && show_dialog && dialog_title == '选择省'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-up.png"></image>
                <image v-if="change && dialog_title != '选择省'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"></image>
            </view>
            <view @click="choose(3)" class="dir-left-nowrap form-item" :class="change ? 'change-item' : ''" v-if="detail.level > 1">
                ...
                <image v-if="change && (show_dialog || show_list) && dialog_title == '选择市'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-up.png"></image>
                <image v-if="change && dialog_title != '选择市'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"></image>
            </view>
            <view @click="choose(4)" class="dir-left-nowrap form-item" :class="change ? 'change-item' : ''" v-if="detail.level == 3">
                ...
                <image v-if="change && (show_dialog || show_list) && dialog_title == '选择区/县'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-up.png"></image>
                <image v-if="change && dialog_title != '选择区/县'" class="more" src="https://cashier.qicuo.com/app/static/image/icon/icon-down.png"></image>
            </view>
