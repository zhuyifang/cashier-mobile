    ...
    <app-layout>
        ...
        <view class="goods-list" v-if="detail.detail && detail.detail.length > 0">
            <view :key="item.id" class="dir-left-nowrap cross-center goods-item" v-for="item in detail.detail">
                <image class="active-icon" src="https://cashier.qicuo.com/app/static/image/icon/form-er.png" style="background-color: #E2E2E2" v-if="item.choose == 2 && order_refund_id == 0">
                </image>
                <image @click="chooseAddress(item)" class="active-icon" src="./../image/active.png" v-else-if="item.choose">
                </image>
                <image @click="chooseAddress(item)" class="active-icon" src="https://cashier.qicuo.com/app/static/image/icon/form-er.png" v-else>
                </image>
            ...
            <template v-if="detail.send_type == 2">
                ...
                <view class="dir-left-nowrap input-item" v-if="is_express == 2">
                    ...
                    <view @click="toPick" class="dir-right-nowrap cross-center" width="width:30%;">
                        <image class="to-more" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png">
                        </image>
                        <text>
                            {{city.delivery}}
                        </text>
