    ...
    <app-layout>
        <view class="balance-head dir-top-nowrap cross-center"
            ...
            <view class="app-button main-center">
                <app-button @click="recharge" fontSize="28" padding="0 13px" background="rgba(255,255,255,0)" color="#FFFFFF" round height="56">{{setting.re_name}}
                </app-button>
                <view style="margin-left: 26rpx;white-space: nowrap">
                    <app-button @click="password" v-if="setting.is_pay_password == 1" fontSize="28" background="rgba(255,255,255,0)" padding="0 13px" color="#FFFFFF" round height="56">设置密码
                    </app-button>
                </view>
            </view>
        </view>
        <!-- 仅跳转 -->
        <app-jump-button v-if="setting.ad_pic_url" :open_type="setting.open_type" :url="setting.page_url"
        ...
        <view class="balance-date main-center cross-center">
            <view class="icon-view cross-center main-center" @click="dateLess">
                <image class="balance-icon" src="https://cashier.qicuo.com/app/static/image/icon/arrow-left.png"></image>
            </view>
            <picker mode="date" :value="date" fields="month" @change="dateChange">
                <view>{{date_a}}</view>
            </picker>
            <view class="icon-view cross-center main-center" @click="datePlus">
                <image class="balance-icon" src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png"></image>
            </view>
        </view>
