<template>
    <app-layout>
                    ...
                    <app-jump-button form
                        ...
                        <view style="width: 100%"
                            ...
                            <view class="box-grow-0" v-if="userCenter.menu_style=='1'">
                                <image src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png" class="arrow"></image>
                            </view>
                        </view>
                    </app-jump-button>
                </view>
        ...
        <view v-if="userInfo && isShowSetting" class="bd-setting dir-left-nowrap main-between cross-center" @click="routerGo">
            <view>设置</view>
            <image src="https://cashier.qicuo.com/app/static/image/icon/arrow-right.png" class="bd-arrow"></image>
        </view>
        <!-- #endif -->
                ...
                menus: function() {
                    ...
                    menus.forEach(item => {
                        if(item.open_type === 'app') {
                            ...
                            let font = '';
                            let padding = '';
                            let arrow = require("https://cashier.qicuo.com/app/static/image/icon/arrow-right.png");
