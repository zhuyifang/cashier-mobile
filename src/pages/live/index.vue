            ...
            <view v-if="list.length" class="list-box">
                <view class="item" v-for="(item, index) in list" :key="index" @click="liveClick(item)">
                    <view class="anchor-img-box">
                        ...
                        <image v-if="item.live_status === 103" class="play-icon" src="https://cashier.qicuo.com/app/static/image/video-play.png"></image>
                    </view>
                    ...
                    <view v-if="item.live_status === 101" class="tag-box tag-box-3">
                        <view class="text">
                            <image class="live-icon" src="https://cashier.qicuo.com/app/static/image/icon/liveing.png"></image>
